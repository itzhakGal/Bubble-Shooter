...
{
    public string fileName = "levels.json"; // עדכן את שם הקובץ אם יש צורך

    public LevelDataList levelDataList; // רשימת השלבים

    public void LoadLevelData()
    {
        // הגדרת נתיב ידני לפי המיקום בפועל של הקובץ
